...
//	}
    ...
    public static final class URevengResponse {
        ...
        public RevengStatus getStatus() {
            return status;
        }

        public Optional<AOTree> getOptLearnedTree() {
            return optLearnedTree;
        }
    ...
    static final class UTripleProducer implements Iterator<Triple> {
        ...
        UTripleProducer(
            ...
            if (s == null) {
                projectedVars.add(Var.alloc("tempS"));
            }
            if (p == null) {
                projectedVars.add(Var.alloc("tempP"));
            }
            if (o == null) {
                projectedVars.add(Var.alloc("tempO"));
            }
